function image_fusion(image_1,image_2,image_3,solution)
...
f_2=imtransform(image_2,tform, 'XYScale',1,'XData',[1 3*N1], 'YData',[1 3*M1]);
% z = imtransform(image_3,tform);	% ���з���任
% imwrite(z,'I:\2020sdw\1517\rift.tif');
%%
...
[~,~,f_3]=mosaic_map(f_1,f_2,grid_size);
     % imwrite(f_1,'I:\2020sdw\1517\riftdyw20150103.tif');
      imwrite(f_3,'E:\20210407paperdata\4\4\H_mosaic.tif');
figure;
imshow(f_3);
